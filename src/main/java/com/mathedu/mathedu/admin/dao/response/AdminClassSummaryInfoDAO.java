...
public class AdminClassSummaryInfoDAO {
    @ApiModelProperty(name = "seq", example = "1", notes = "반의 DB상의 시퀀스 번호", required = true)
    private Integer seq;
    ...
    @ApiModelProperty(name = "teacher", example = "선생님", notes = "선생님 이름", required = true)
    private String teacher;
    @ApiModelProperty(name = "studentCnt", example = "10", notes = "총 학생 수", required = true)
